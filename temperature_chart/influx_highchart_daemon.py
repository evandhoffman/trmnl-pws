        ...
        if data_points:
            ...
            most_recent[entity_id] = {
                ...
                "display_name": display_names.get(
                    entity_id,
                    entity_id.replace("evan_s_pws_temp", "")
                    .replace("evan_s_pws_temperature", "")
                    .replace("_", " ")
                    .title(),
                ),
            }
...
def main():
    ...
    while True:
        try:
            ...
            logger.info(
                f"Querying temperature data for the past {hours_back} hours ({start_time} to {end_time})"
            )
            ...
            sleep_seconds = 300
            logger.info(
                f"Waiting {sleep_seconds} seconds before next data collection..."
            )
